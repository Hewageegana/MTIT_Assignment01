package supermarketserviceconsumer_search;
...
import supermarketserviceproducer_search.SupermarketServiceSearch;
...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext bundleContext) throws Exception {
		...
		serviceReference = context.getServiceReference(SupermarketServiceSearch.class.getSimpleName());
